...
messages.en = {
    ...
    toastEmpty: 'This folder is empty.',
    ...
    titleAudit: 'Audit Logs',
    auditTodayTotal: 'Total Operations Today',
    auditTodayUpload: 'Uploaded Today',
    auditTodayDownload: 'Downloaded Today',
    auditTodayAlerts: 'Security Alerts',
    auditColTime: 'Time',
    auditColUser: 'User',
    auditColAction: 'Action',
    auditColPath: 'Target Path',
    auditColTargetPath: 'Destination',
    auditColIp: 'Client IP',
    auditColStatus: 'Status',
    auditColSize: 'Size',
    auditFilterAction: 'Action Type',
    auditFilterStatus: 'Status',
    auditFilterTime: 'Time Range',
    auditFilterSearch: 'Search path, IP, user...',
    auditFilterTimeAll: 'All time',
    auditFilterTime24h: 'Last 24 hours',
    auditFilterTime7d: 'Last 7 days',
    auditFilterTime30d: 'Last 30 days',
    auditExportCsv: 'Export CSV',
    auditRefresh: 'Refresh',
    auditDetailTitle: 'Audit Record Detail',
    auditActionAll: 'All',
    auditStatusAll: 'All',
    auditStatusSuccess: 'Success',
    auditStatusFailed: 'Failed',
    auditAnonymousUser: 'anonymous',
};
messages['zh-CN'] = {
    ...
    titleAudit: '审计日志',
    auditTodayTotal: '今日操作总数',
    auditTodayUpload: '今日上传量',
    auditTodayDownload: '今日下载量',
    auditTodayAlerts: '安全拦截次数',
    auditColTime: '操作时间',
    auditColUser: '操作用户',
    auditColAction: '动作类型',
    auditColPath: '目标路径',
    auditColTargetPath: '目标位置',
    auditColIp: '客户端 IP',
    auditColStatus: '状态',
    auditColSize: '文件大小',
    auditFilterAction: '操作类型',
    auditFilterStatus: '执行状态',
    auditFilterTime: '时间范围',
    auditFilterSearch: '搜索路径、IP、用户名...',
    auditFilterTimeAll: '全部时间',
    auditFilterTime24h: '最近 24 小时',
    auditFilterTime7d: '最近 7 天',
    auditFilterTime30d: '最近 30 天',
    auditExportCsv: '导出 CSV',
    auditRefresh: '刷新',
    auditDetailTitle: '审计记录详情',
    auditActionAll: '全部',
    auditStatusAll: '全部',
    auditStatusSuccess: '成功',
    auditStatusFailed: '失败',
    auditAnonymousUser: '匿名',
};
// https://zhconvert.org/
// 在 zh-CN 的基础上执行“香港化”
messages['zh-HK'] = {
