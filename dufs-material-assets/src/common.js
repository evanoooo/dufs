...
export const previewableImageExts = new Set(['bmp', 'jpg', 'jpeg', 'gif', 'png', 'webp', 'avif', 'jxl', 'svg']);
...
export const previewablePhotopeaExts = new Set(['psd', 'ai', 'xd', 'fig', 'sketch', 'indd', 'ico', 'dds', 'tga', 'tiff', 'heif', 'heic']);
